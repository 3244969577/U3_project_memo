...
// public static class NPCSpriteToolAsync
// {   
...
//     {
//         /*
//         new npc with init_position

//         add component SpriteRenderer
//         add component NPC_Genearted
//         add component BoxCollider2D

//         split sprite into sprites

//         add component NPC4DirFrameAnimator with sprites
//         add component NPCMovement

//         ----- CreateDialogConfiguration -----
//         new child("DialogConfig") with components:
//             NPCDialogueConfig
//         add to npc component Dialogable with DialogConfig

//         new child("Character") with components:
//             Character
        
//         new child("Flowchart") with components:
//             Flowchart

//         ----- GenerateDialogueFlowchart -----
//         trim response as rsp
//         parse rsp into List<DialogueNode> as nodes
//         new AIDialogueConfig as config with nodes

//         generateFlowchart with flowchart and config
//         */
...
public class NPCSpriteToolAsync : Singleton<NPCSpriteToolAsync>
{
    public GameObject npc_Prefab;
    public float scale = 6;     // sprite 放大倍数
