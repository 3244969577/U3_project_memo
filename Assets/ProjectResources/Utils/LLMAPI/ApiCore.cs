...
// {
//     [JsonProperty("model")] public string Model = "doubao-seed-2-0-pro-260215";
//     [JsonProperty("messages")] public List<ChatMessage> Messages = new();
//     [JsonProperty("temperature")] public float Temperature = 1f; // 回复随机性：0=最稳定，1=最随机
//     [JsonProperty("stream")] public bool Stream = false; // 流式输出，后面优化会用到
//     [JsonProperty("thinking")] public string Thinking = "disable"; // 是否思考，disable=不思考，enable=思考
// }
// // 单条对话消息结构
